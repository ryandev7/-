...
/**
 * Servlet implementation class AjaxProductFruitListController
 */
@WebServlet("/plist.fru")
public class AjaxProductFruitListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxProductFruitListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// * listCount : 총 게시글 개수
		listCount = new ProductService().selectFruitListCount();
		...
		ArrayList<Product> list = new ProductService().selectFruitList(pi.get(0));
