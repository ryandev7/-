...
/**
 * Servlet implementation class AjaxProductVegetableListController
 */
@WebServlet("/plist.veg")
public class AjaxProductVegetableListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxProductVegetableListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// * listCount : 총 게시글 개수
		listCount = new ProductService().selectVegetableListCount();
		...
		ArrayList<Product> list = new ProductService().selectVegetableList(pi.get(0));
