 ...
 */
@WebServlet("/qnaList.pr")
public class AjaxProductQnaListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxProductQnaListController() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new QnaService().selectQnaCount(prNo);
		...
		ArrayList<QNA> list = new QnaService().selectQnaList(prNo, pi.get(0));
		
		ArrayList<ArrayList> qna = new ArrayList<ArrayList>();
		
		ArrayList<QNA> answer = new QnaService().selectAnsList(list);
