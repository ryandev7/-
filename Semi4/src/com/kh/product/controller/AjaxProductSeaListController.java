...
/**
 * Servlet implementation class AjaxProductSeaListController
 */
@WebServlet("/plist.sea")
public class AjaxProductSeaListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxProductSeaListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// * listCount : 총 게시글 개수
		listCount = new ProductService().selectSeaListCount();
		...
		ArrayList<Product> list = new ProductService().selectSeaList(pi.get(0));
