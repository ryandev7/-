...
/**
 * Servlet implementation class AjaxProductMeatListController
 */
@WebServlet("/plist.meat")
public class AjaxProductMeatListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxProductMeatListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 필요한 변수들
				...
				// * listCount : 총 게시글 개수
				listCount = new ProductService().selectMeatListCount();
				...
				ArrayList<Product> list = new ProductService().selectMeatList(pi.get(0));
