...
/**
 * Servlet implementation class AjaxProductEctListController
 */
@WebServlet("/plist.etc")
public class AjaxProductEtcListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxProductEtcListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// * listCount : 총 게시글 개수
		listCount = new ProductService().selectEtcListCount();
		...
		ArrayList<Product> list = new ProductService().selectEtcList(pi.get(0));
